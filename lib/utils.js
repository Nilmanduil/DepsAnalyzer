/**
 *
 * @param {object} jsonValue element to format
 * @param {string} jsonKey key of the element to format
 * @param {object} opts options
 * @param {number} indentationLevel level of indentation for the current line
 * @param {boolean} isLastElement whether the element is the last of the parent element
 * @returns
 */
